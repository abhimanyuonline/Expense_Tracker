...
class TimeOfDaySpendChart extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final List<String> bands = ['Morning', 'Afternoon', 'Evening', 'Night'];
    final colors = [
      const Color(0xFFFCD34D), // Morning Yellow
      const Color(0xFFFBA949), // Afternoon Orange
      const Color(0xFF6366F1), // Evening Purple
      const Color(0xFF312E81), // Night Dark
    ];

    double maxVal = 0;
    for (var val in timeSpend.values) {
